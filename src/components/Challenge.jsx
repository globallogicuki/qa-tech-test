  ...
  <section id="challenge">
    <Paper className={"challenge"} style={paperStyle} zDepth={3}>
      ...
      <div>
        ...
        <p> Your job is to use a browser based testing tool to read the dom and create an array data structure for each of the rows.</p>
        <p>
          Once you have each array,
          write some code that is able to return the index of the array where the sum of integers at the index on the left is equal to the sum of integers on the right.</p>
